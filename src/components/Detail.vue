        ...
        <div class="main">
            <div class="course-info">
                ...
                <div class="wrap-right">
                    ...
                    <p class="data">{{course_detail.students}}人在学&nbsp;&nbsp;&nbsp;&nbsp;课程总时长：{{course_detail.lessons}}课时/已经更新{{course_detail.pub_lessons}}课时&nbsp;&nbsp;&nbsp;&nbsp;难度：{{course_detail.level}}</p>
                    <div class="sale-time" v-if="course_detail.active_time" >
                        <p class="sale-type" v-if="">{{course_detail.discount_name}}</p>
                        <p class="expire" >距离结束：仅剩 {{parseInt(course_detail.active_time / 86400)}}天 {{parseInt(course_detail.active_time /3600 % 24)}}小时 {{parseInt(course_detail.active_time /60 %60)}}分 <span class="second">{{course_detail.active_time % 60}}</span> 秒</p>
                    </div>
                    ...
                    <div class="buy">
                        ...
                        <div class="add-cart"><img src="/static/image/cart-yellow.svg" alt=""><span @click="add_cart">加入购物车</span></div>
                    </div>
                </div>
            </div>
            ...
            <div class="course-content">
                <div class="course-tab-list">
                    ...
                    <div class="tab-item" v-if="tabIndex==2">
                        <div class="tab-item-title">
                            ...
                            <p class="chapter-length">共8章 {{course_detail.lesson}}个课时</p>
                        </div>
                ...
                <div class="course-side">
                    <div class="teacher-info">
                        <h4 class="side-title"><span>{{course_detail.teacher.title}} {{course_detail.teacher.role}}</span></h4>
